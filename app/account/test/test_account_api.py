...
# def create_account(operational_responsable,team_id, **params):
...
#     account = Account.objects.create(operational_responsable=operational_responsable,team_id=team_id, **defaults)
#     return account
...
#             team_name = 'Team Name Test',
#             coworkers = [self.user,]
#         )

#     def test_retrieve_accounts(self):
#         """Test retrieving a list of accounts."""
#         create_account(operational_responsable=self.user, team_id=self.team)
#         create_account(operational_responsable=self.user, team_id=self.team)
